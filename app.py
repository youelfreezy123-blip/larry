...
if st.button("🔥 CALCULER LA LIQUIDATION DOUANIÈRE", type="primary"):
    ...
    if fob_total <= 0:
        ...
        if choix == 1:
            ...
            # Calculs individuels
            df_art1, mdt_1 = calculer_liquidation("Article 1", caf_art1, taux_dd_1, taux_assise, promad_ajoute)
            df_art2, mdt_2 = calculer_liquidation("Article 2", caf_art2, taux_dd_2, taux_assise, promad_ajoute)
